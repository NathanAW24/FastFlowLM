...
- NPU-accelerated kernels are **proprietary binaries**: free for **commercial use unless your company’s annual revenue exceeds USD 10 million**. Above that threshold, a commercial license is required. See [LICENSE_BINARY.txt](./LICENSE_BINARY.txt) and [TERMS.md](./TERMS.md) for details.  
