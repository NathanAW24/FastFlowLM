---
title: LLaMA 3.x Benchmark Results
parent: Benchmarks
nav_order: 1
---
...
|------------------|--------------------|--------:|--------:|--------:|--------:|---------:|---------:|---------:|----------:|
| **LLaMA 3.2 1B**  | NPU (FLM)    | 41.5   | 40.6   | 38.1   | 33.2   | 25.6    | 18.6    | 12.2    | 8.9      |
|                  | NPU (RAI)   | 18.6   | 14.9   | *NA*   | *NA*    | *NA*     | *NA*     | *NA*     | *NA*      |
|                  | iGPU                | 28.7   | 19.0   | 10.9   | 6.0    | 3.2     | 1.6     | 0.8     | OOM      |
|                  | CPU                 | 54.6   | 52.6   | 42.3   | 34.1   | 24.4    | 14.8    | 8.4     | OOM      |
| **LLaMA 3.2 3B**  | NPU (FLM)    | 18.3   | 17.8   | 15.9   | 13.6   | 10.5     | 7.3     | 6.3     | OOM      |
|                  | NPU (RAI)   | 9.0   | 6.1   | *NA*   | *NA*    | *NA*     | *NA*     | *NA*     | *NA*      |
|                  | iGPU                | 23.2   | 18.8   | 14.0   | 9.2    | 5.5     | 3.0     | OOM     | OOM      |
|                  | CPU                 | 22.6   | 21.3   | 17.5   | 14.1   | 9.4     | 6.1     | OOM     | OOM      |
| **LLaMA 3.1 8B**  | NPU (FLM)    | 9.1    | 9.0    | 8.3    | 7.5    | 6.2     | 4.6     | OOM     | OOM      |
|                  | NPU (RAI)   | 6.3   | 4.6    | *NA*   | *NA*    | *NA*     | *NA*     | *NA*     | *NA*      |
|                  | iGPU                | 11.3   | 9.9    | 7.7    | 5.4    | 3.4     | OOM     | OOM     | OOM      |
|                  | CPU                 | 10.3   | 7.7    | 7.6    | 6.7    | 5.8     | OOM     | OOM     | OOM      |
...
|------------------|--------------------|--------:|--------:|--------:|--------:|---------:|---------:|
| **LLaMA 3.2 1B** | NPU (FLM)    | 0.76|	1.16|	2.41|	5.76|	16.93|	57.02|
| **LLaMA 3.2 3B**  | NPU (FLM)    | 1.81|	2.64|	5.56|	14.05|	43.88|	152.91|
| **LLaMA 3.1 8B**   | NPU (FLM)    | 3.04|	4.53|	9.32|	21.79|	61.46|	195.65|